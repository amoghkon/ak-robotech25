#define BLYNK_TEMPLATE_ID  "TMPL2gHOyI9Ch"
#define BLYNK_TEMPLATE_NAME  "KeypadAuth"
#include <esp_now.h>
#include <WiFi.h>
...
char authToken[33]{"zcWy8RMnKi1ZGLdwD8bTUcyTXCi7AAc2"};
char ssid[12]{"Galaxy-Kash"};
char pass[9]{"Akash123"};
...
uint8_t broadcastAddress[] = {0x90, 0x15, 0x06, 0x94, 0x04, 0xc4}; // mac address of receiver
int testData = 24;
int uncData;
